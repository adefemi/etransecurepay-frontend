...
const initialState = {
    adminStatus: null, enquiryList: null, maxperlist: 10, currentPage : 1, totalPages : 1,
    ...
    componentWillReceiveProps(props){
        ...
        if(props.userContent.hasOwnProperty('enquiryList')){
            if(props.userContent.enquiryList !== this.state.enquiryList){
                ...
                this.setState({totalPages: Math.ceil(props.userContent.enquiryList.length / this.state.maxperlist)})
            }
        }
    }
            ...
            <div>
                ...
                <div className={'container'}>
                    ...
                    <div className={'userList'} data-aos-once="true" data-aos="fade-up" data-aos-easing="ease-out-back" data-aos-duration="500">
                        ...
                        {
                            this.state.enquiryList === null ? <h2>Loading</h2> :
                                this.state.enquiryList.length < 1 ? <h2>No Enquiry found!</h2> :
                                    this.enquiryList()
                        }
                    ...
                    <div className={'pagination'} data-aos-once="true" data-aos="fade-up" data-aos-easing="ease-out-back" data-aos-delay="200" data-aos-duration="500">
                        {this.state.enquiryList === null ? null :
                            this.state.enquiryList.length < 1 ? null :
